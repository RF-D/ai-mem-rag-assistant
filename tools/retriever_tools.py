...
def retriever_tool_meta(vectorstore):
    def retrieve_documents(query):
        ...
        docs = vectorstore.similarity_search(query, k=50)  # Adjust the value of k as needed
        ...
        reranker = VoyageAIRerank(
            ...
            top_k=10,  # Adjust the value of top_k as needed
        ...
        compression_retriever = ContextualCompressionRetriever(
            ...
            base_retriever=vectorstore.as_retriever(search_kwargs={"k": 50})  # Adjust the value of k as needed
        )
